...
<img src="pics/test1.jpg" alt="alt text" width="800">

Second test picture:

<img src="pics/test2.jpg" alt="alt text" width="800">
...
I modified the deformation intensity and the radius of influence here, and reused part of the interactive code from the first task.

在这里我修改了形变强度和变化半径，用了第一个任务中的部分交互代码
```python
...
<img src="pics/run_global_transform-checkpoint_result.png" alt="alt text" width="800">

<img src="pics/run_global_transform-checkpoint_result2.png" alt="alt text" width="800">

### Point Guided Deformation:
<img src="pics/run_point_transform-checkpoint_result.png" alt="alt text" width="800">

<img src="pics/run_point_transform-checkpoint_result2.png" alt="alt text" width="800">
